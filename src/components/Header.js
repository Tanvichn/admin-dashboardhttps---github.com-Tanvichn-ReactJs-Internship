...
const NavBar = () => {
  return (
    ...
    <div>
        ...
        <div className="flex flex-wrap max-w-screen-xl p-5">
          <a
    ...
    <nav className="bg-gradient-to-r from-blue-100 to-pink-100 flex flex-wrap justify-between m-5 mt-2 rounded-lg shadow-md">
